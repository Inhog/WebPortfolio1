						...
						<div class="row">
							<div class="col-lg-6">
								<form role="form" method="POST"
									action="<c:url value='/member/read' />">
									<div class="form-group">
										<label for="disabledSelect">MEMBER_SEQ Disabled input
										</label> <input class="form-control" type="text" name="MEMBER_SEQ"
											value="33333-3333-UUID333333333333" readonly>
